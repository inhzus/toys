...
template <typename T> struct remove_func_cv { using type = T; };
template <typename R, typename C, typename... Args>
struct remove_func_cv<R (C::*)(Args...) const>
    : public remove_func_cv<R (C::*)(Args...)> {};
template <typename R, typename C, typename... Args>
struct remove_func_cv<R (C::*)(Args...) volatile>
    : public remove_func_cv<R (C::*)(Args...)> {};
template <typename R, typename C, typename... Args>
struct remove_func_cv<R (C::*)(Args...) const volatile>
    : public remove_func_cv<R (C::*)(Args...)> {};

template <typename T> using remove_func_cv_t = typename remove_func_cv<T>::type;

template <typename T, typename = void>
struct func_traits : func_traits<remove_func_cv_t<T>> {};
template <typename R, typename C, typename... Args>
struct func_traits<R (C::*)(Args...)> { // void (foo::Bar::*)(int, float)
  using result_type = R;
